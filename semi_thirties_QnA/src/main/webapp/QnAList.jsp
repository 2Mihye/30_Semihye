				...
				<div class="contents">
					...
					<table border="1" id="qnA" style="border-collapse:collapse; vertical-align: middle;">
						...
						<tr style="  border-bottom: 1px solid rgba(0,0,0,.1);">
							...
							<td style="padding:8px;"><a href="QnADetail.jsp?qnaNo=<%=qna.getQnaNo()%>"> <%= qna.getQnaTitle() %> </td>
							<td style="text-align:center;padding:8px;"><a href="QnADetail.jsp?qnaNo=<%=qna.getQnaNo()%>"> <%= qna.getAccountID() %> </td>
